...
struct PatternsLibrary {
	...
	uint8_t up3 [UP3_SIZE  * 2][UP3_SIZE  * UP3_SIZE];
	uint8_t up5 [UP5_SIZE  * 2][UP5_SIZE  * UP5_SIZE];
	uint8_t up7 [UP7_SIZE  * 2][UP7_SIZE  * UP7_SIZE];
	uint8_t up9 [UP9_SIZE  * 2][UP9_SIZE  * UP9_SIZE];
	uint8_t up11[UP11_SIZE * 2][UP11_SIZE * UP11_SIZE];
